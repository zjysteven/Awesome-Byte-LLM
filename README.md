...
|-------|:------------:|:------:|:----:|---------|
| [Dynamic Chunking for End-to-End Hierarchical Sequence Modeling](https://arxiv.org/pdf/2507.07955) | 06/25 | CMU goombalab | [official](https://github.com/goombalab/hnet) | <details>The paper introduces H-Net, an end-to-end hierarchical network with a novel dynamic chunking mechanism that automatically learns data-driven, context-dependent segmentation, outperforming tokenized Transformers in efficiency and robustness, and demonstrating the potential of fully tokenizer-free large language models across diverse languages and modalities.</details> |
| [EvaByte: Efficient Byte-level Language Models at Scale](https://hkunlp.github.io/blog/2025/evabyte/) | 01/25 | HKU NLP Group | [official](https://github.com/OpenEvaByte/evabyte) | <details>EvaByte is a new open-source 6.5B byte-level language model from HKU and SambaNova that eliminates tokenization, achieves faster and more efficient decoding with innovative multibyte prediction and EVA attention, and demonstrates strong performance across text, code, and multimodal tasks using significantly less training data.</details> |
...
| [SpaceByte: Towards Deleting Tokenization from Large Language Modeling](https://arxiv.org/pdf/2404.14408) | 10/24 | NeurIPS'24 | - | <details>The paper proposes a new byte-level Transformer architecture called SpaceByte, which uses dynamic word-boundary-aware patching and multiscale modeling to close the performance gap with tokenized models while retaining the benefits of tokenization-free language modeling under fixed compute budgets.</details> |
...
| [ByT5: Towards a token-free future with pre-trained byte-to-byte models](https://arxiv.org/pdf/2105.13626) | 05/21 | TACL | [official](https://github.com/google-research/byt5) | <details>The paper presents ByT5, a token-free byte-to-byte variant of the T5 Transformer that processes raw UTF-8 byte sequences without tokenization, achieving competitive performance across multilingual NLP tasks, offering robustness to noise, and demonstrating improved efficiency, especially in low-resource or multilingual contexts.</details> |
| [CANINE: Pre-training an Efficient Tokenization-Free Encoder for Language Representation](https://arxiv.org/pdf/2103.06874) | 03/21 | TACL | [official](https://github.com/google-research/language/tree/master/language/canine) | <details>The paper introduces CANINE, a tokenization-free neural encoder that directly processes character sequences using a downsampling-transformer-upsampling architecture, achieving competitive multilingual performance on tasks like TYDI QA and NER while offering efficiency and robustness advantages over traditional subword-based models.</details> |
